                    ...
                    <div class="card-body">
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="plan_starter">
                                <strong>Formule Starter</strong> - 100€ par salarié par an
                                <ul>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="plan_premium">
                                <strong>Formule Premium</strong> - 180€ par salarié par an
                                <ul>
            ...
            <div class="col-lg-4">
                <div class="card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= APP_URL ?>/actions/quote_process.php" method="post">
