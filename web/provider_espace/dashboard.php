...
<div class="main-content">
    ...
    <div class="topbar">
        ...
        <small class="text-muted"><?= htmlspecialchars($user['specialization']) ?>
            <?= $user['is_verified'] ? '<span class="verification-badge"><i class="fas fa-check-circle"></i></span>' : '' ?></small>
    </div>
</div>
</div>
                        ...
                        <?php foreach ($upcomingAppointments as $appointment): ?>
                            <div class="calendar-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span
                                        class="badge bg-<?= $appointment['status'] === 'scheduled' ? 'primary' : ($appointment['status'] === 'confirmed' ? 'success' : 'warning') ?>">
        ...
        <?php if ($user['is_verified'] != 1): ?>
            <div class="card mb-4 border-warning">
                <div class="card-header bg-warning-soft">
                    <h5 class="mb-0 text-warning"><i class="fas fa-exclamation-triangle me-2"></i>Vérification en attente
                    </h5>
                </div>
                <div class="card-body">
                    <p>Votre compte est en cours de vérification par l'équipe Business Care. Une fois vérifié, vous pourrez
                        recevoir plus de demandes de services.</p>
                    <p class="mb-0">Si vous n'avez pas encore soumis tous vos documents, veuillez compléter votre profil :
                    </p>
